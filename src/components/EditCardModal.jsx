...
const EditCardModal = ({ video, setShowModal }) => {
  ...
  const successNotify = () => toast.success("Video actualizado con exito!");
  const errorNotify = () => toast.error("Error al actualizar el video!");
    ...
    <>
      ...
      <div className="edit-card-modal_overlay">
        <div className="edit-card-modal__container">
          <button className="edit-card-modal__close" onClick={() => setShowModal(false)}>
            <FaXmark />
          </button>
          <h1>Editar Card</h1>
          <form onSubmit={handleSubmit(onSubmit)} className="edit-card-modal__form">
            ...
            <div className="form-field__container">
              ...
              <input
                {...register("image")}
                type="text"
                placeholder="Ejm: https://i.ytimg.com/..."
              />
            </div>
            <div className="form-field__container">
